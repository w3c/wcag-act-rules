...
The ACT Rules are **proposed** by the ACT Rules Community Group. Once a rule is fully implemented by at least one test tool or methodology, the rule is **reviewed and approved** by a W3C Working Group. The Accessibility Guidelines Working Group approves rules for WCAG, the ARIA Working Group approves rules for ARIA. A rule can be **deprecated** if it is no longer necessary, or superseded by other rules.
