...
permalink: /standards-guidelines/act/rules/80f0bf/
ref: /standards-guidelines/act/rules/80f0bf/
lang: en
github:
  repository: w3c/wcag-act-rules
  path: content/rules/80f0bf/index.md
...
- [`audio` or `video` that plays automatically has a control mechanism](/standards-guidelines/act/rules/80f0bf/)
- [`Audio` or `video` that plays automatically has no audio that lasts more than 3 seconds](/standards-guidelines/act/rules/80f0bf/)
