...
permalink: /standards-guidelines/act/rules/eac66b/
ref: /standards-guidelines/act/rules/eac66b/
lang: en
github:
  repository: w3c/wcag-act-rules
  path: content/rules/eac66b/index.md
...
- [`video` element content is media alternative for text](/standards-guidelines/act/rules/eac66b/)
- [`video` element auditory content has captions](/standards-guidelines/act/rules/eac66b/)
