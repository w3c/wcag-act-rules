...
permalink: /standards-guidelines/act/rules/c3232f/
ref: /standards-guidelines/act/rules/c3232f/
lang: en
github:
  repository: w3c/wcag-act-rules
  path: content/rules/c3232f/index.md
...
- [`video` element visual-only content is media alternative for text](/standards-guidelines/act/rules/c3232f/)
- [`video` element visual-only content has transcript](/standards-guidelines/act/rules/c3232f/)
- [`video` element visual-only content has audio track alternative](/standards-guidelines/act/rules/c3232f/)
