...
permalink: /standards-guidelines/act/rules/focusable-no-keyboard-trap-non-standard-nav-ebe86a/
ref: /standards-guidelines/act/rules/focusable-no-keyboard-trap-non-standard-nav-ebe86a/
lang: en
github:
...
{% include_relative implementations/ebe86a.md %}
